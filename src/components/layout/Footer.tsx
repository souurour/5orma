      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-indigo-200 mb-4 max-w-md">
              Advanced BI platform for denim manufacturing companies, providing
              role-based access, real-time alerts, machine monitoring, and
        ...
        <div className="mt-8 pt-8 border-t border-indigo-800">
          <p className="text-sm text-indigo-200">
            &copy; {currentYear} MIC Service Laser. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
